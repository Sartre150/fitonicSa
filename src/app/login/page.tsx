      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mt-6">
          <button
            ...
            disabled={loading}
            type="button"
            className="w-full bg-white hover:bg-zinc-100 text-zinc-950 font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
